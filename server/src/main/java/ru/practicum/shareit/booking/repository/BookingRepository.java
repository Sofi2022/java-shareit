...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    @Query("select b from Booking b join fetch b.item where b.booker.id = :userId and b.start > :now and b.end > :now order by b.start desc")
    ...
    @Query("select b from Booking b join fetch b.item where b.booker.id = :userId and b.item.id = :itemId and" +
            " b.status = :status and b.end < :time")
